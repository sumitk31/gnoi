...
func (StartContainerRequest_Restart_Policy) EnumDescriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{20, 3, 0}
}
...
func (LocalDriverOptions_Type) EnumDescriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{32, 0}
}
...
type DeployRequest struct {
	...
	//	*DeployRequest_SignedBundleContent
	//	*DeployRequest_SignedBundleTransferEnd
...
func (x *DeployRequest) GetSignedBundleContent() []byte {
	if x != nil {
		if x, ok := x.Request.(*DeployRequest_SignedBundleContent); ok {
			return x.SignedBundleContent
		}
	}
	return nil
}

func (x *DeployRequest) GetSignedBundleTransferEnd() *SignedBundleTransferEnd {
	if x != nil {
		if x, ok := x.Request.(*DeployRequest_SignedBundleTransferEnd); ok {
			return x.SignedBundleTransferEnd
		}
	}
	return nil
}
...
type DeployRequest_SignedBundleContent struct {
	SignedBundleContent []byte `protobuf:"bytes,4,opt,name=signed_bundle_content,json=signedBundleContent,proto3,oneof"`
}

type DeployRequest_SignedBundleTransferEnd struct {
	SignedBundleTransferEnd *SignedBundleTransferEnd `protobuf:"bytes,5,opt,name=signed_bundle_transfer_end,json=signedBundleTransferEnd,proto3,oneof"`
}
...
func (*DeployRequest_SignedBundleContent) isDeployRequest_Request() {}

func (*DeployRequest_SignedBundleTransferEnd) isDeployRequest_Request() {}
...
type ImageTransfer struct {
	...
	SignedBundleSize uint64                 `protobuf:"varint,6,opt,name=signed_bundle_size,json=signedBundleSize,proto3" json:"signed_bundle_size,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *ImageTransfer) GetSignedBundleSize() uint64 {
	if x != nil {
		return x.SignedBundleSize
	}
	return 0
}
...
type SignedBundleTransferEnd struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *SignedBundleTransferEnd) Reset() {
	*x = SignedBundleTransferEnd{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SignedBundleTransferEnd) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedBundleTransferEnd) ProtoMessage() {}

func (x *SignedBundleTransferEnd) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedBundleTransferEnd.ProtoReflect.Descriptor instead.
func (*SignedBundleTransferEnd) Descriptor() ([]byte, []int) {
...
type DeployResponse struct {
	...
	//	*DeployResponse_SignedBundleTransferReady
	//	*DeployResponse_SignedBundleTransferProgress
...
func (x *DeployResponse) GetSignedBundleTransferReady() *SignedBundleTransferReady {
	if x != nil {
		if x, ok := x.Response.(*DeployResponse_SignedBundleTransferReady); ok {
			return x.SignedBundleTransferReady
		}
	}
	return nil
}

func (x *DeployResponse) GetSignedBundleTransferProgress() *SignedBundleTransferProgress {
	if x != nil {
		if x, ok := x.Response.(*DeployResponse_SignedBundleTransferProgress); ok {
			return x.SignedBundleTransferProgress
		}
	}
	return nil
}
...
type DeployResponse_SignedBundleTransferReady struct {
	SignedBundleTransferReady *SignedBundleTransferReady `protobuf:"bytes,5,opt,name=signed_bundle_transfer_ready,json=signedBundleTransferReady,proto3,oneof"`
}

type DeployResponse_SignedBundleTransferProgress struct {
	SignedBundleTransferProgress *SignedBundleTransferProgress `protobuf:"bytes,6,opt,name=signed_bundle_transfer_progress,json=signedBundleTransferProgress,proto3,oneof"`
}
...
func (*DeployResponse_SignedBundleTransferReady) isDeployResponse_Response() {}

func (*DeployResponse_SignedBundleTransferProgress) isDeployResponse_Response() {}
...
type SignedBundleTransferReady struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ChunkSize     int32                  `protobuf:"varint,1,opt,name=chunk_size,json=chunkSize,proto3" json:"chunk_size,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SignedBundleTransferReady) Reset() {
	*x = SignedBundleTransferReady{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SignedBundleTransferReady) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedBundleTransferReady) ProtoMessage() {}

func (x *SignedBundleTransferReady) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedBundleTransferReady.ProtoReflect.Descriptor instead.
func (*SignedBundleTransferReady) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{7}
}

func (x *SignedBundleTransferReady) GetChunkSize() int32 {
	if x != nil {
		return x.ChunkSize
	}
	return 0
...
type SignedBundleTransferProgress struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	BytesReceived uint64                 `protobuf:"varint,1,opt,name=bytes_received,json=bytesReceived,proto3" json:"bytes_received,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *SignedBundleTransferProgress) Reset() {
	*x = SignedBundleTransferProgress{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SignedBundleTransferProgress) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedBundleTransferProgress) ProtoMessage() {}

func (x *SignedBundleTransferProgress) ProtoReflect() protoreflect.Message {
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[8]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedBundleTransferProgress.ProtoReflect.Descriptor instead.
func (*SignedBundleTransferProgress) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{8}
}

func (x *SignedBundleTransferProgress) GetBytesReceived() uint64 {
	if x != nil {
		return x.BytesReceived
	}
	return 0
...
func (*RemovePluginResponse) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{48}
}
...
func (*RemovePluginTarRequest) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{49}
}
...
func (*RemovePluginTarResponse) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{50}
}
...
func (x *StartContainerRequest_Capabilities) Reset() {
	*x = StartContainerRequest_Capabilities{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[56]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StartContainerRequest_Capabilities) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{20, 2}
}
...
func (*StartContainerRequest_Restart) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{20, 3}
}
...
func (*StartContainerRequest_RunAs) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{20, 4}
}
...
func (*StartContainerRequest_Limits) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{20, 6}
}
...
func (x *ListVolumeRequest_Filter) Reset() {
	*x = ListVolumeRequest_Filter{}
	mi := &file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[63]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListVolumeRequest_Filter) Descriptor() ([]byte, []int) {
	return file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDescGZIP(), []int{38, 0}
}
...
const file_github_com_openconfig_gnoi_containerz_containerz_proto_rawDesc = "" +
	...
	"\x0fRemovePluginTar\x12'.gnoi.containerz.RemovePluginTarRequest\x1a(.gnoi.containerz.RemovePluginTarResponse\"\x00B/\xd2>\x050.3.0Z%github.com/openconfig/gnoi/containerzb\x06proto3"
...
var file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes = make([]protoimpl.MessageInfo, 66)
var file_github_com_openconfig_gnoi_containerz_containerz_proto_goTypes = []any{
	...
	(*SignedBundleTransferEnd)(nil),            // 9: gnoi.containerz.SignedBundleTransferEnd
	(*DeployResponse)(nil),                     // 10: gnoi.containerz.DeployResponse
	(*ImageTransferReady)(nil),                 // 11: gnoi.containerz.ImageTransferReady
	(*ImageTransferProgress)(nil),              // 12: gnoi.containerz.ImageTransferProgress
	(*SignedBundleTransferReady)(nil),          // 13: gnoi.containerz.SignedBundleTransferReady
	(*SignedBundleTransferProgress)(nil),       // 14: gnoi.containerz.SignedBundleTransferProgress
	...
	(*RemovePluginTarRequest)(nil),             // 55: gnoi.containerz.RemovePluginTarRequest
	(*RemovePluginTarResponse)(nil),            // 56: gnoi.containerz.RemovePluginTarResponse
	(*ListImageRequest_Filter)(nil),            // 57: gnoi.containerz.ListImageRequest.Filter
	(*ListContainerRequest_Filter)(nil),        // 58: gnoi.containerz.ListContainerRequest.Filter
	nil,                                        // 59: gnoi.containerz.ListContainerResponse.LabelsEntry
	(*StartContainerRequest_Port)(nil),         // 60: gnoi.containerz.StartContainerRequest.Port
	nil,                                        // 61: gnoi.containerz.StartContainerRequest.EnvironmentEntry
	(*StartContainerRequest_Capabilities)(nil), // 62: gnoi.containerz.StartContainerRequest.Capabilities
	(*StartContainerRequest_Restart)(nil),      // 63: gnoi.containerz.StartContainerRequest.Restart
	(*StartContainerRequest_RunAs)(nil),        // 64: gnoi.containerz.StartContainerRequest.RunAs
	nil,                                        // 65: gnoi.containerz.StartContainerRequest.LabelsEntry
	(*StartContainerRequest_Limits)(nil),       // 66: gnoi.containerz.StartContainerRequest.Limits
	nil,                                        // 67: gnoi.containerz.CustomOptions.OptionsEntry
	nil,                                        // 68: gnoi.containerz.CreateVolumeRequest.LabelsEntry
	(*ListVolumeRequest_Filter)(nil),           // 69: gnoi.containerz.ListVolumeRequest.Filter
	nil,                                        // 70: gnoi.containerz.ListVolumeResponse.OptionsEntry
	nil,                                        // 71: gnoi.containerz.ListVolumeResponse.LabelsEntry
	(*common.RemoteDownload)(nil),              // 72: gnoi.common.RemoteDownload
	(*status.Status)(nil),                      // 73: google.rpc.Status
	(*types.HashType)(nil),                     // 74: gnoi.types.HashType
...
var file_github_com_openconfig_gnoi_containerz_containerz_proto_depIdxs = []int32{
	...
	9,  // 2: gnoi.containerz.DeployRequest.signed_bundle_transfer_end:type_name -> gnoi.containerz.SignedBundleTransferEnd
	72, // 3: gnoi.containerz.ImageTransfer.remote_download:type_name -> gnoi.common.RemoteDownload
	11, // 4: gnoi.containerz.DeployResponse.image_transfer_ready:type_name -> gnoi.containerz.ImageTransferReady
	12, // 5: gnoi.containerz.DeployResponse.image_transfer_progress:type_name -> gnoi.containerz.ImageTransferProgress
	15, // 6: gnoi.containerz.DeployResponse.image_transfer_success:type_name -> gnoi.containerz.ImageTransferSuccess
	73, // 7: gnoi.containerz.DeployResponse.image_transfer_error:type_name -> google.rpc.Status
	13, // 8: gnoi.containerz.DeployResponse.signed_bundle_transfer_ready:type_name -> gnoi.containerz.SignedBundleTransferReady
	14, // 9: gnoi.containerz.DeployResponse.signed_bundle_transfer_progress:type_name -> gnoi.containerz.SignedBundleTransferProgress
	57, // 10: gnoi.containerz.ListImageRequest.filter:type_name -> gnoi.containerz.ListImageRequest.Filter
	58, // 11: gnoi.containerz.ListContainerRequest.filter:type_name -> gnoi.containerz.ListContainerRequest.Filter
	1,  // 12: gnoi.containerz.ListContainerResponse.status:type_name -> gnoi.containerz.ListContainerResponse.Status
	59, // 13: gnoi.containerz.ListContainerResponse.labels:type_name -> gnoi.containerz.ListContainerResponse.LabelsEntry
	74, // 14: gnoi.containerz.ListContainerResponse.hash:type_name -> gnoi.types.HashType
	2,  // 15: gnoi.containerz.Device.permissions:type_name -> gnoi.containerz.Device.Permission
	60, // 16: gnoi.containerz.StartContainerRequest.ports:type_name -> gnoi.containerz.StartContainerRequest.Port
	61, // 17: gnoi.containerz.StartContainerRequest.environment:type_name -> gnoi.containerz.StartContainerRequest.EnvironmentEntry
	24, // 18: gnoi.containerz.StartContainerRequest.volumes:type_name -> gnoi.containerz.Volume
	62, // 19: gnoi.containerz.StartContainerRequest.cap:type_name -> gnoi.containerz.StartContainerRequest.Capabilities
	63, // 20: gnoi.containerz.StartContainerRequest.restart:type_name -> gnoi.containerz.StartContainerRequest.Restart
	64, // 21: gnoi.containerz.StartContainerRequest.run_as:type_name -> gnoi.containerz.StartContainerRequest.RunAs
	65, // 22: gnoi.containerz.StartContainerRequest.labels:type_name -> gnoi.containerz.StartContainerRequest.LabelsEntry
	66, // 23: gnoi.containerz.StartContainerRequest.limits:type_name -> gnoi.containerz.StartContainerRequest.Limits
	25, // 24: gnoi.containerz.StartContainerRequest.devices:type_name -> gnoi.containerz.Device
	3,  // 25: gnoi.containerz.StartContainerRequest.location:type_name -> gnoi.containerz.StartContainerRequest.Location
	28, // 26: gnoi.containerz.StartContainerResponse.start_ok:type_name -> gnoi.containerz.StartOK
	29, // 27: gnoi.containerz.StartContainerResponse.start_error:type_name -> gnoi.containerz.StartError
	26, // 28: gnoi.containerz.UpdateContainerRequest.params:type_name -> gnoi.containerz.StartContainerRequest
	34, // 29: gnoi.containerz.UpdateContainerResponse.update_ok:type_name -> gnoi.containerz.UpdateOK
	35, // 30: gnoi.containerz.UpdateContainerResponse.update_error:type_name -> gnoi.containerz.UpdateError
	5,  // 31: gnoi.containerz.LocalDriverOptions.type:type_name -> gnoi.containerz.LocalDriverOptions.Type
	67, // 32: gnoi.containerz.CustomOptions.options:type_name -> gnoi.containerz.CustomOptions.OptionsEntry
	0,  // 33: gnoi.containerz.CreateVolumeRequest.driver:type_name -> gnoi.containerz.Driver
	68, // 34: gnoi.containerz.CreateVolumeRequest.labels:type_name -> gnoi.containerz.CreateVolumeRequest.LabelsEntry
	...
	69, // 37: gnoi.containerz.ListVolumeRequest.filter:type_name -> gnoi.containerz.ListVolumeRequest.Filter
	75, // 38: gnoi.containerz.ListVolumeResponse.created:type_name -> google.protobuf.Timestamp
	70, // 39: gnoi.containerz.ListVolumeResponse.options:type_name -> gnoi.containerz.ListVolumeResponse.OptionsEntry
	71, // 40: gnoi.containerz.ListVolumeResponse.labels:type_name -> gnoi.containerz.ListVolumeResponse.LabelsEntry
	74, // 41: gnoi.containerz.Plugin.hash:type_name -> gnoi.types.HashType
	...
	6,  // 44: gnoi.containerz.Containerz.Deploy:input_type -> gnoi.containerz.DeployRequest
	...
	55, // 60: gnoi.containerz.Containerz.RemovePluginTar:input_type -> gnoi.containerz.RemovePluginTarRequest
	10, // 61: gnoi.containerz.Containerz.Deploy:output_type -> gnoi.containerz.DeployResponse
	21, // 62: gnoi.containerz.Containerz.ListImage:output_type -> gnoi.containerz.ListImageResponse
	17, // 63: gnoi.containerz.Containerz.RemoveImage:output_type -> gnoi.containerz.RemoveImageResponse
	19, // 64: gnoi.containerz.Containerz.RemoveContainer:output_type -> gnoi.containerz.RemoveContainerResponse
	23, // 65: gnoi.containerz.Containerz.ListContainer:output_type -> gnoi.containerz.ListContainerResponse
	27, // 66: gnoi.containerz.Containerz.StartContainer:output_type -> gnoi.containerz.StartContainerResponse
	31, // 67: gnoi.containerz.Containerz.StopContainer:output_type -> gnoi.containerz.StopContainerResponse
	33, // 68: gnoi.containerz.Containerz.UpdateContainer:output_type -> gnoi.containerz.UpdateContainerResponse
	37, // 69: gnoi.containerz.Containerz.Log:output_type -> gnoi.containerz.LogResponse
	41, // 70: gnoi.containerz.Containerz.CreateVolume:output_type -> gnoi.containerz.CreateVolumeResponse
	43, // 71: gnoi.containerz.Containerz.RemoveVolume:output_type -> gnoi.containerz.RemoveVolumeResponse
	45, // 72: gnoi.containerz.Containerz.ListVolume:output_type -> gnoi.containerz.ListVolumeResponse
	47, // 73: gnoi.containerz.Containerz.StartPlugin:output_type -> gnoi.containerz.StartPluginResponse
	49, // 74: gnoi.containerz.Containerz.StopPlugin:output_type -> gnoi.containerz.StopPluginResponse
	52, // 75: gnoi.containerz.Containerz.ListPlugins:output_type -> gnoi.containerz.ListPluginsResponse
	54, // 76: gnoi.containerz.Containerz.RemovePlugin:output_type -> gnoi.containerz.RemovePluginResponse
	56, // 77: gnoi.containerz.Containerz.RemovePluginTar:output_type -> gnoi.containerz.RemovePluginTarResponse
...
func file_github_com_openconfig_gnoi_containerz_containerz_proto_init() {
	...
	file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*DeployRequest_SignedBundleContent)(nil),
		(*DeployRequest_SignedBundleTransferEnd)(nil),
	}
	file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[4].OneofWrappers = []any{
		...
		(*DeployResponse_SignedBundleTransferReady)(nil),
		(*DeployResponse_SignedBundleTransferProgress)(nil),
	}
	file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[21].OneofWrappers = []any{
		(*StartContainerResponse_StartOk)(nil),
		(*StartContainerResponse_StartError)(nil),
	}
	file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[27].OneofWrappers = []any{
		(*UpdateContainerResponse_UpdateOk)(nil),
		(*UpdateContainerResponse_UpdateError)(nil),
	}
	file_github_com_openconfig_gnoi_containerz_containerz_proto_msgTypes[34].OneofWrappers = []any{
